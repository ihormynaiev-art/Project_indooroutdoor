                ...
                <div class="row">
                    <div class="col-lg-7 col-sm-12 m-auto">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="prio" value="{{ $category->prio }}" type="number" class="form-control">
                        </div>
                        <div class="form-groupheads d-flex mb-4">
                            <h2>Active</h2>
                            <div class="mx-2 active-switch">
                                <label class="switch">
                                    <input name="is_active" @checked($category->is_active) value="1" type="checkbox">
                        ...
                        <div class="form-groupheads d-flex mb-4">
                            ...
                            <div class="mx-2 active-switch">
                                <label class="switch">
                                    <input name="is_license_required"
                                           @checked($category->is_license_required)
                                           value="1"
                                           type="checkbox">
                                    <span class="sliders round"></span>
                                </label>
                        ...
                        <div class="form-groupheads d-flex mb-4">
                            ...
                            <div class="mx-2 active-switch">
                                <label class="switch">
                                    <input name="show_in_home_top_slider"
                                           @checked($category->show_in_home_top_slider)
                                           value="1"
                                           type="checkbox">
                                    <span class="sliders round"></span>
                                </label>
